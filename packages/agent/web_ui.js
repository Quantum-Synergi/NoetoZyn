...
<header class="header"><div><h1>NoetoZyn</h1><p class="subtitle">Solana devnet proof dashboard. Biometric values are always simulated / slot-seeded.</p></div><div class="header-actions"><button class="nz-btn" id="plain-toggle">Plain-language view</button><span class="nz-badge-blue" id="network-badge">Checking RPC...</span></div></header>
