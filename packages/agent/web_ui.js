...
<section class="nz-panel nz-panel-coral"><h2 class="nz-panel-title">Create local proof receipt</h2><p class="nz-panel-sub">Create a browser-only proof artifact. Nothing is uploaded.</p><button class="nz-btn" id="download-proof">Download local proof receipt (.json)</button><button class="nz-btn" id="show-qr">Show Proof QR</button><div id="qr-output"></div><p class="status" id="proof-status" aria-live="polite">Mobile: use Share, then Save to Files.</p></section>
<hr>
