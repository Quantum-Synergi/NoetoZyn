...
<header class="header"><div><h1>NoetoZyn</h1><p class="subtitle">A judge-facing Solana devnet proof dashboard. Biometric values are always simulated / slot-seeded.</p></div><div class="header-actions"><button class="nz-btn" id="plain-toggle">Plain-language view</button><span class="nz-badge-blue" id="network-badge">Checking RPC...</span></div></header>
...
<section class="nz-panel nz-panel-blue"><h2 class="nz-panel-title">Commit this checkpoint on-chain <span class="nz-badge-blue">real write</span></h2><p class="nz-panel-sub">Uses one fresh server-side slot-seeded capture. No telemetry values are accepted from the browser.</p><button class="nz-btn" id="commit-button" disabled>Commit this checkpoint</button><p class="status" id="commit-status" aria-live="polite">Run a simulated capture first.</p></section>
